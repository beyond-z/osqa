...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.course_id'
        db.add_column(u'forum_user', 'course_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.course_id'
        db.delete_column(u'forum_user', 'course_id')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 9, 11, 0, 0)'}),
        ...
        'forum.subscriptionsettings': {
            ...
            'new_question': ('django.db.models.fields.CharField', [], {'default': "'i'", 'max_length': '1'}),
        ...
        'forum.user': {
            ...
            'course_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 9, 12, 0, 0)'}),
